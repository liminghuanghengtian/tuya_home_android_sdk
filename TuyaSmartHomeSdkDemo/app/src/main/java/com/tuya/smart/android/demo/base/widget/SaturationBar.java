...
public class SaturationBar extends View {
    ...
    public interface OnSaturationSelectedListener {
        void onSaturationSelected(int saturation);
    }
    ...
    public void setOnSaturationSelectedListener(OnSaturationSelectedListener onSaturationChangedListener) {
        this.onSaturationSelectedListener = onSaturationChangedListener;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (onSaturationSelectedListener != null && mColor != oldChangedListenerSaturation) {
                    onSaturationSelectedListener.onSaturationSelected(mColor);
                    oldChangedListenerSaturation = mColor;
                }
                break;
        }
    ...
    public void setColor(int color, int status) {
        ...
        if (mPicker != null) {
            ...
            if (mPicker.hasValueBar())
                mPicker.changeValueBarColor(mColor, status);
     ...
     */
    public void setSaturation(float saturation, int status) {
    ...
    public int getValue() {
        float v = (mBarPointerPosition - mBarPointerHaloRadius) / mSatToPosFactor;
        if (v > 1) v = 1;
        else if (v < 0) v = 0;
        return (int) (v * 255);
    }
    ...
    public void setValue(int value) {
        ...
        setSaturation(value / 255.0f);
    }

    public void setSaturation(float saturation) {
        setSaturation(saturation, ColorPicker.S_RESPONING);
    }
