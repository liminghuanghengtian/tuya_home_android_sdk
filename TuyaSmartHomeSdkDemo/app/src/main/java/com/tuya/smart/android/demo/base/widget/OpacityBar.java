...
public class OpacityBar extends View {
    ...
    private OnOpacitySelectedListener onOpacitySelectedListener;

    public void setOnOpacitySelectedListener(OnOpacitySelectedListener listener) {
        this.onOpacitySelectedListener = listener;
    }
    ...
    public interface OnOpacitySelectedListener {
        void onOpacitySelected(int opacity);
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (onOpacitySelectedListener != null && oldChangedListenerOpacity != getOpacity()) {
                    onOpacitySelectedListener.onOpacitySelected(getOpacity());
                    oldChangedListenerOpacity = getOpacity();
                }
                break;
        }
     ...
     */
    public void setOpacity(int opacity, int status) {
    ...
    public void setOpacity(int opacity) {
        setOpacity(opacity, ColorPicker.S_RESPONING);
    }
