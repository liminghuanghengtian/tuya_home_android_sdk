...
public class VectorDrawable extends DrawableCompat implements Tintable {
    ...
    public void setColor(int color) {
        Paint fillPaint = mVectorState.mVPathRenderer.mFillPaint;
        if (fillPaint == null) {
            fillPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            fillPaint.setStyle(Paint.Style.FILL);
            mVectorState.mVPathRenderer.mFillPaint = fillPaint;
        }
        mVectorState.mVPathRenderer.setSelfColorOpen(true);
    ...
    public static VectorDrawable create(Resources resources, int rid) {
        try {
            ...
            drawable.inflate(resources, parser, attrs, null, 0);
    ...
    public static VectorDrawable getDrawable(Context c, int resId, int color) {
        return create(c.getResources(), resId, color);
    }

    public static VectorDrawable create(Resources resources, int rid, int color) {
        try {
            final XmlPullParser parser = resources.getXml(rid);
            final AttributeSet attrs = Xml.asAttributeSet(parser);
            int type;
            ...
            final VectorDrawable drawable = new VectorDrawable();
            drawable.inflate(resources, parser, attrs, null, color);
    ...
    public void inflate(Resources res, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme, int color)
            throws XmlPullParserException, IOException {
        final VectorDrawableState state = mVectorState;
        final VPathRenderer pathRenderer = new VPathRenderer();
        state.mVPathRenderer = pathRenderer;
        final TypedArray a = obtainAttributes(res, theme, attrs, com.wnafee.vector.R.styleable.VectorDrawable);
        updateStateFromTypedArray(a);
        a.recycle();
    ...
    private void updateStateFromTypedArray(TypedArray a) throws XmlPullParserException {
        ...
        final int tintMode = a.getInt(com.wnafee.vector.R.styleable.VectorDrawable_vc_tintMode, -1);
        if (tintMode != -1) {
            state.mTintMode = parseTintMode(tintMode, PorterDuff.Mode.SRC_IN);
        }

        final ColorStateList tint = a.getColorStateList(com.wnafee.vector.R.styleable.VectorDrawable_vc_tint);
        if (tint != null) {
            state.mTint = tint;
        }

        state.mAutoMirrored = a.getBoolean(
                com.wnafee.vector.R.styleable.VectorDrawable_vc_autoMirrored, state.mAutoMirrored);

        pathRenderer.mViewportWidth = a.getFloat(
                com.wnafee.vector.R.styleable.VectorDrawable_vc_viewportWidth, pathRenderer.mViewportWidth);
        pathRenderer.mViewportHeight = a.getFloat(
                com.wnafee.vector.R.styleable.VectorDrawable_vc_viewportHeight, pathRenderer.mViewportHeight);
        ...
        pathRenderer.mBaseWidth = a.getDimension(
                com.wnafee.vector.R.styleable.VectorDrawable_android_width, pathRenderer.mBaseWidth);
        pathRenderer.mBaseHeight = a.getDimension(
                com.wnafee.vector.R.styleable.VectorDrawable_android_height, pathRenderer.mBaseHeight);
        ...
        final float alphaInFloat = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawable_android_alpha,
                pathRenderer.getAlpha());
        pathRenderer.setAlpha(alphaInFloat);

        final String name = a.getString(com.wnafee.vector.R.styleable.VectorDrawable_android_name);
        if (name != null) {
    ...
    private static class VPathRenderer {
        ...
        private boolean mSelfColorOpen;
        ...
        public void setSelfColorOpen(boolean selfColorOpen) {
            this.mSelfColorOpen = selfColorOpen;
        }
    }
    ...
    private static class VGroup {
        ...
        public void inflate(Resources res, AttributeSet attrs, Resources.Theme theme) {
            final TypedArray a = obtainAttributes(res, theme, attrs,
                    com.wnafee.vector.R.styleable.VectorDrawableGroup);
            updateStateFromTypedArray(a);
            a.recycle();
        }
...
//            mThemeAttrs = a.extractThemeAttrs();
            ...
            mRotate = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_android_rotation, mRotate);
            mPivotX = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_android_pivotX, mPivotX);
            mPivotY = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_android_pivotY, mPivotY);
            mScaleX = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_android_scaleX, mScaleX);
            mScaleY = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_android_scaleY, mScaleY);
            mTranslateX = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_vc_translateX, mTranslateX);
            mTranslateY = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawableGroup_vc_translateY, mTranslateY);

            final String groupName = a.getString(com.wnafee.vector.R.styleable.VectorDrawableGroup_android_name);
            if (groupName != null) {
...
//            a.recycle();
    ...
    private static class VClipPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Resources.Theme theme) {
            final TypedArray a = obtainAttributes(r, theme, attrs,
                    com.wnafee.vector.R.styleable.VectorDrawableClipPath);
            updateStateFromTypedArray(a);
            a.recycle();
        }
        ...
        private void updateStateFromTypedArray(TypedArray a) {
            ...
            final String pathName = a.getString(com.wnafee.vector.R.styleable.VectorDrawableClipPath_android_name);
            if (pathName != null) {
                mPathName = pathName;
            }

            final String pathData = a.getString(com.wnafee.vector.R.styleable.VectorDrawableClipPath_vc_pathData);
            if (pathData != null) {
    ...
    protected static class VFullPath extends VPath {
        ...
        public void inflate(Resources r, AttributeSet attrs, Resources.Theme theme) {
            final TypedArray a = obtainAttributes(r, theme, attrs,
                    com.wnafee.vector.R.styleable.VectorDrawablePath);
            updateStateFromTypedArray(a);
            a.recycle();
        }
        ...
        private void updateStateFromTypedArray(TypedArray a) {
            ...
            final String pathName = a.getString(com.wnafee.vector.R.styleable.VectorDrawablePath_android_name);
            if (pathName != null) {
                mPathName = pathName;
            }

            final String pathData = a.getString(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_pathData);
            if (pathData != null) {
                mNodes = PathParser.createNodesFromPathData(pathData);
            }

            mFillColor = a.getColor(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_fillColor, mFillColor);
            mFillAlpha = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_fillAlpha, mFillAlpha);
            mStrokeLineCap = getStrokeLineCap(a.getInt(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_strokeLineCap, -1), mStrokeLineCap);
            mStrokeLineJoin = getStrokeLineJoin(a.getInt(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_strokeLineJoin, -1), mStrokeLineJoin);
            mStrokeMiterlimit = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_strokeMiterLimit, mStrokeMiterlimit);
            mStrokeColor = a.getColor(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_strokeColor, mStrokeColor);
            mStrokeAlpha = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_strokeAlpha, mStrokeAlpha);
            mStrokeWidth = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_strokeWidth, mStrokeWidth);
            mTrimPathEnd = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_trimPathEnd, mTrimPathEnd);
            mTrimPathOffset = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_trimPathOffset, mTrimPathOffset);
            mTrimPathStart = a.getFloat(com.wnafee.vector.R.styleable.VectorDrawablePath_vc_trimPathStart, mTrimPathStart);
        }
